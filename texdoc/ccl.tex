...
\item
\doerror{WRONGELEMENT} A callback did not follow the element-processing protocol. For example, range transform and fold callbacks must return a positive value on success rather than zero.
\item
